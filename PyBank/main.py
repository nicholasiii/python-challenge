...
print("Total Profit/Loss:      $"+format(profit_loss, ',.2f'))
print("Average Monthly Change:      $"+format(average_change, ',.2f'))
print("Greatest Monthly Increase:      "+greatestincmonth+"       $"+format(greatestinc, ',.2f'))
print("Greatest Monthly Decrease:   "+greatestdecmonth+"       $"+format(greatestdec, ',.2f'))
